...
@WebServlet(urlPatterns ="/SendMailAttachServlet")
...
public class SendMailAttachServlet extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3716328355486260756L;
	private String host;
	private String port;
	private String user;
	private String pass;
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			getServletContext().getRequestDispatcher("/jobs.jsp").forward(
					request, response);
		}
	}
