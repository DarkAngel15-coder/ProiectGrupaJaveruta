...
<title>Audio Video Engineer</title>
...
<body class="backgroundv002">
    ...
    <div>
       ...
       <div >
        ...
        <br>
        <br>
        <p class="span_p">Publicat 16 Ian 2020 | Expira in 07 Feb 2021 </p>
        
        <h1 class="h1">Audio Video Engineer</h1> 
       ...
       <div class="div_left">
           ...
           <span>
             ...
             - Good communication.
             <br>
             - Multimedia working experience (Video coprocessor, USB, MMC&SD CARD, IRDA…).
             <br>
             - Get a working experience on Mobile phones and system platforms (GSM, EDGE, WCDMA…)
             <br>
             - Able to provide support to Sw people for issue analysis related to audio analogical part
       ...
       <div class="div_left">
           ...
           <span>
             ...
             - Provide corrections on Sysol platform or customer phone.
             <br>
             - Train customers and provide support for the local customer support team.
             <br>
             - Deploy new platform to our customer.
